...
const CTA = () => {
  return (
    <section className="py-6">
      <Wrapper className="">
        <SlideUpTransition className="px-3 py-8 md:px-6 md:py-12 rounded-lg bg-[#4E42D7] relative flex flex-col justify-center items-center font-jetBrainsMono">
