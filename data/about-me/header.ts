export const AboutHeaderData = {
  ...
  lines: [
    `They call me the "Code Whisperer" of Lagos (not officially, but whispers travel fast ). By day, I weave magic with pixels, crafting responsive websites from scratch. Think of me as your digital sugar daddy (but with better coding skills and less... sugar), transforming online experiences with a sprinkle of code. By night? Well, okay, it's still coding, but when I'm not coding, well the city's not gonna save itself. I fight crimes and other whisperers like me(though I'm more charming😊)`,
    ...
    `And because the tech world moves faster than a rogue Danfo bus or a highway gala seller, I'm constantly learning new frameworks and languages. No website is too complex, no code too cryptic – I can decipher it all (like a love letter, if you will). Learning keeps things exciting, you know? Like that time I decided to venture into the world of DevOps...I didn't get it but it was fun😂.`,
  ],
